...
class CBKViewModel extends ViewModel {
    ...
    public boolean isVisibleAccmMilg(String expnDivCd){
        return expnDivCd.equalsIgnoreCase(VariableType.getExpnDivCd(VariableType.INSIGHT_EXPN_DIV_CODE_1000))||expnDivCd.equalsIgnoreCase(VariableType.getExpnDivCd(VariableType.INSIGHT_EXPN_DIV_CODE_1100))||expnDivCd.equalsIgnoreCase(VariableType.getExpnDivCd(VariableType.INSIGHT_EXPN_DIV_CODE_2000));
    }
