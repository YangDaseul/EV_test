...
//    GRA_MYP_8003("MyG+ 오픈소스라이센스", "MYP-8003", HttpRequest.METHOD_POST, "/graapi/myp/openLicense.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    ...
    GRA_GNS_1008("My차고 + 렌트/리스 계약서이미지 등록", "GNS-1008", HttpRequest.METHOD_POST, "/graapi/gns/myRentContractImg.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_GNS_1009("My차고 + 렌트/리스 재직증명서 이미지 등록", "GNS-1009", HttpRequest.METHOD_POST, "/graapi/gns/myRentCertificateImg.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
