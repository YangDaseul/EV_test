...
public enum ChargeBtrStatus {
    ...
    STATUS_1500("1500", "서비스 전", "픽업 서비스가 %s에\n예약되어 있습니다."),
    STATUS_2000("2000", "픽업중", "기사님이 차량을 픽업하여 이동 중입니다."),
    STATUS_3000("3000", "서비스중", "서비스 진행 중입니다."),
    STATUS_4000("4000", "딜리버리중", "기사님이 픽업 위치로 딜리버리 중입니다."),
