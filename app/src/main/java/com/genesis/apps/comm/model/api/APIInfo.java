...
//    GRA_MYP_8003("MyG+ 오픈소스라이센스", "MYP-8003", HttpRequest.METHOD_POST, "/graapi/myp/openLicense.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    ...
    // 픽업앤충전 서비스/간편결제
    GRA_CHB_1001("service + 픽업앤충전 서비스 상태 >> 삭제", "CHB-1001", HttpRequest.METHOD_POST, "/graapi/chb/", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1002("service + 픽업앤충전 정보제공동의화면", "CHB-1002", HttpRequest.METHOD_POST, "/graapi/chb/infoAgmtView.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1003("service + 픽업앤충전 정보제공동의 설정", "CHB-1003", HttpRequest.METHOD_POST, "/graapi/chb/infoAgmtSet.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1004("service + 픽업앤충전 제공동의 조회", "CHB-1004", HttpRequest.METHOD_POST, "/graapi/chb/infoAgmtGet.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1005("service + 픽업앤충전 서비스 소개", "CHB-1005", HttpRequest.METHOD_POST, "/graapi/chb/chbSvcIntro.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1006("service + 디지털키 공유가능 여부", "CHB-1006", HttpRequest.METHOD_POST, "/graapi/chb/dgtlKeyShaYn.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1007("service + 픽업앤충전 서비스 가능지역 확인", "CHB-1007", HttpRequest.METHOD_POST, "/graapi/chb/sevPosLocCheck.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1008("service + 픽업앤충전 예약 가능일시 조회", "CHB-1008", HttpRequest.METHOD_POST, "/graapi/chb/bokPosDateSearch.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1009("service + 픽업앤충전 상품 가격 정보", "CHB-1009", HttpRequest.METHOD_POST, "/graapi/chb/proPriInfo.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1010("service + 픽업앤충전 서비스 신청", "CHB-1010", HttpRequest.METHOD_POST, "/graapi/chb/serviceReg.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1011("service + 간편결제 회원가입(웹뷰 화면)", "CHB-1011", HttpRequest.METHOD_POST, "/graapi/chb/easyPayMemberReg.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1012("service + 간편결제 회원 가입(웹뷰 결과) >> 삭제", "CHB-1012", HttpRequest.METHOD_POST, "/graapi/chb/", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1013("service + 간편결제 카드 등록(웹뷰 화면)", "CHB-1013", HttpRequest.METHOD_POST, "/graapi/chb/easyPayCardReg.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1014("service + 간편결제 카드 등록(웹뷰 결과) >> 삭제", "CHB-1014", HttpRequest.METHOD_POST, "/graapi/chb/", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    ...
    GRA_CHB_1022("service + 픽업앤충전 서비스 기사위치 정보 조회", "CHB-1022", HttpRequest.METHOD_POST, "/graapi/chb/workerLocGet.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1023("service + 픽업앤충전 서비스 신청이력 조회", "CHB-1023", HttpRequest.METHOD_POST, "/graapi/chb/aplctHstryGet.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1024("service + 픽업앤충전 서비스 신청쉬소", "CHB-1024", HttpRequest.METHOD_POST, "/graapi/chb/chbSvcCncl.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1025("service + 회원탈퇴(픽업앤충전/간편결제)", "CHB-1025", HttpRequest.METHOD_POST, "/graapi/chb/withdrawal.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1026("service + 신청이력 상세정보", "CHB-1026", HttpRequest.METHOD_POST, "/graapi/chb/aplctHstryDetailGet.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
