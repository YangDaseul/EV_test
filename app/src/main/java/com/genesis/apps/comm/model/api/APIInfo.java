...
//    GRA_MYP_8003("MyG+ 오픈소스라이센스", "MYP-8003", HttpRequest.METHOD_POST, "/graapi/myp/openLicense.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    ...
    GRA_CHB_1003("service + 충전버틀러 정보제공동의 설정", "CHB-1003", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1004("service + 충전버틀러 제공동의 조회", "CHB-1004", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1005("service + 충전버틀러 서비스 소개", "CHB-1005", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1006("service + 디지털키 공유가능 여부", "CHB-1006", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1007("service + 충전버틀러 서비스 가능지역 확인", "CHB-1007", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1008("service + 충전버틀러 예약 가능일시 조회", "CHB-1008", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1009("service + 충전버틀러 상품 가격 정보", "CHB-1009", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1010("service + 충전버틀러 서비스 신청", "CHB-1010", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1011("service + 간편결제 회원가입(웹뷰 화면)", "CHB-1011", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1012("service + 간편결제 회원 가입(웹뷰 결과)", "CHB-1012", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1013("service + 간편결제 카드 등록(웹뷰 화면)", "CHB-1013", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1014("service + 간편결제 카드 등록(웹뷰 결과)", "CHB-1014", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1015("service + 결제수단 조회", "CHB-1015", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1016("service + 주카드 등록", "CHB-1016", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1017("service + 결제수단 삭제", "CHB-1017", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1018("service + 추가예상비용안내", "CHB-1018", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1019("service + 리뷰문구 요청", "CHB-1019", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1020("service + 리뷰 평가", "CHB-1020", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1021("service + 충전버틀러 서비스 신청현황/예약 조회", "CHB-1021", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
    GRA_CHB_1022("service + 충전버틀러 서비스 기사위치 정보 조회", "CHB-1022", HttpRequest.METHOD_POST, "/graapi/chb/receStatus.do", HttpRequest.CONTENT_TYPE_JSON, HttpRequest.CHARSET_UTF8),
