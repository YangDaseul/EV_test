...
//        int flagSwipe = ItemTouchHelper.START | ItemTouchHelper.END; //item swipe
        ...
        /**
         ...
         item drag int flagSwipe = ItemTouchHelper.START | ItemTouchHelper.END;item swipe
         **/
...
//
    ...
    public boolean onMove(@NonNull RecyclerView
                                  recyclerView, @NonNull RecyclerView.ViewHolder fromHolder, @NonNull RecyclerView.ViewHolder
                                  targetHolder) {
