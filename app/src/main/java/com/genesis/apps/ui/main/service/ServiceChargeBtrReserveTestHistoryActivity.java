...
public class ServiceChargeBtrReserveTestHistoryActivity extends GpsBaseActivity<ActivityServiceChargeBtrHistoryBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_charge_btr_test_history);
        getDataFromIntent();
        setViewModel();
        setObserver();
        initView();
