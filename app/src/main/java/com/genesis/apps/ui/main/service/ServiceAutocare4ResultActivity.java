...
import com.genesis.apps.databinding.ActivityServiceAutocare4ResultBinding;
 ...
 * @brief 오토케어 4단계
 */
public class ServiceAutocare4ResultActivity extends SubActivity<ActivityServiceAutocare4ResultBinding> {
    private RepairReserveVO repairReserveVO;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_service_autocare_4_result);
        getDataFromIntent();
        setViewModel();
        setObserver();
    }
