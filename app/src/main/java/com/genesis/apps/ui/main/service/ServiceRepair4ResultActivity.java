 ...
 * @brief 정비예약 4단계
 */
public class ServiceRepair4ResultActivity extends SubActivity<ActivityServiceRepair4ResultBinding> {
    private RepairReserveVO repairReserveVO;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_service_repair_4_result);
        getDataFromIntent();
        setViewModel();
        setObserver();
    }
