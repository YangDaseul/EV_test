...
public class ServiceDriveReqActivity extends SubActivity<ActivityCont1Binding> {

    private final int[] layouts = {R.layout.activity_service_drive_req, R.layout.activity_service_drive_req, R.layout.activity_service_drive_req, R.layout.activity_service_drive_req};
