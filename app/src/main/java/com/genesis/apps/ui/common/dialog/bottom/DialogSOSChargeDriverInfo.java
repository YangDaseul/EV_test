...
import com.genesis.apps.databinding.DialogBottomSosChargeDriverInfoBinding;
import com.genesis.apps.databinding.DialogBottomSosDriverInfoBinding;
import com.genesis.apps.ui.common.view.listener.OnSingleClickListener;

public class DialogSOSChargeDriverInfo extends BaseBottomDialog<DialogBottomSosChargeDriverInfoBinding> {

    private SOS_3006.Response data;
    private int minute;
    public DialogSOSChargeDriverInfo(@NonNull Context context, int theme) {
        super(context, theme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_bottom_sos_charge_driver_info);
...
//            ui.tvMemo.setText(data.getMemo());
    ...
    public SOS_3006.Response getData() {
        return data;
    }

    public void setData(SOS_3006.Response data) {
        this.data = data;
    }
